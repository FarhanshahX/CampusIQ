...
const ProfileScreen = () => {
  ...
  const pickImage = async () => {
    ...
    if (!result.canceled) {
      // Create a data URI for the image to store in the DB
    ...
    <ScrollView style={styles.container} contentContainerStyle={styles.content}>
        ...
        {!isEditing && (
          <View style={styles.headerInfo}>
            ...
            <Text style={styles.headerSubtitle}>
              {teacher?.employeeId} • {designation}
            </Text>
          </View>
        )}
      </View>
          ...
          <View style={styles.infoList}>
            ...
            <View style={styles.infoItem}>
              ...
              <View style={styles.infoContent}>
                ...
                <Text style={styles.infoValue}>{teacher?.employeeId}</Text>
              </View>
            </View>
          </View>
        )}
      ...
      <View style={styles.card}>
        ...
        <Text style={styles.helperText}>
          Select your currently active subject. Screens will defaults to this
        ...
        {subjects.map((subject) => {
          ...
          return (
            <TouchableOpacity
              key={subject._id}
              style={[styles.subjectRow, isActive && styles.subjectRowActive]}
              onPress={() => changeActiveSubject(subject)}
            >
              <View style={styles.subjectInfo}>
                <Text
                  style={[styles.subjectName, isActive && styles.textActive]}
                >
                  {subject.subjectName}
                </Text>
                <Text
                  style={[styles.subjectCode, isActive && styles.textActive]}
                >
                  {subject.subjectCode}
                </Text>
              </View>
        ...
        {subjects.length === 0 && (
          <Text style={styles.helperText}>No subjects assigned to you.</Text>
        )}
      </View>
